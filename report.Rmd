...
Figure 1 shows us the changes in each CSAP subject area from 2009-2010. Initially we do see that math scores increased, writing scores decreased, and reading scores remained stagnant, we must perform further analysis in order to come to a more concrete conclusion. We utilize a statistical method known as "bootstrapping" in order to help us come to said conclusion. 
